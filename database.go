...
type Cart struct{
	...
	IdCustomers int 	`json:"IdCustomers"`
	idProducts 	int 	`json:"IdProducts"`
}
...
type OrderDetails struct {
	...
	CardCVC 	int 	`json:"CardCVC"`
	CardMonth 	int 	`json:"CardMonth"`
	CardYear 	int 	`json:"CardYear"`
}

type Products struct {
	IdProducts 			int 	`json:"IdProducts"`
	ProductName			string 	`json:"ProductName"`
	Price 				int 	`json:"Price"`  //STRING OR INT?
	ProductDescription 	string 	`json:"ProductDescription"`
	UnitsInStock		int 	`json:"UnitsInStock"`
	ProductAvailable	bool	`json:"ProductAvailable"` //bool? int?
}
